...
async def async_read_inverter_firmware_info(hub: Any) -> int:
    ...
    try:
        ...
        data["firmware_dsp"] = int(inverter_data[0])
        ...
        data["firmware_arm"] = int(inverter_data[6])
    ...
    if version >= 100:
        ...
        try:
            ...
            data["firmware_version_dsp"] = int(full_version_data[0])
            data["firmware_version_arm"] = int(full_version_data[1])
        except Exception:
